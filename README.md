...
Options:
  -e, --event-type <EVENT_TYPE>   Event type to include; repeat to include multiple types. Limit applies after filtering [possible values: create, delete, issue-comment, issues, pull-request, pull-request-review, push, release]
