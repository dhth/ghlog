...
Options:
  -e, --event-type <EVENT_TYPE>   Filter by event type; repeat to include multiple types. Limit applies after filtering [possible values: create, delete, comment, issues, pull-request, pull-request-review, push, release]
